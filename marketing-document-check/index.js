exports.onExecutePostLogin = async (event, api) => {
    ...
    const backendUrl = `${event.secrets.CONSENT_SERVER_BACKEND_URL}/compare?clientId=${CLIENT_ID}&userId=${USER_ID}&countryCode=${countryCode}&isMarketingDocument=true&isMandatory=true`;
